...
\section{Education}
  \CVSubHeadingListStart
    \CVSubheading
      ...
      {Paris Diderot university (currently Paris-cité university)}{France}
    \CVSubheading
...
%      {School}{Where}
\CVSubheadingshort
{Prix Peccot from Collège de France}{2024}
{}{}
    \CVSubheadingshort
...
\CVSubheading
{ANR}{2023}
{Part of the ANR team OPART}{France}
    \CVSubheading
...
\section{Scientific and administrative responsibilities}
 \CVSubHeadingListStart
  \CVSubheading
      {Summer school YMC*A}{2021}
      {Organisation member}{Germany}
      \CVSubheading
      {PhD students seminar Paris Diderot}{2017-2018}
      {Organisation member}{France}
          \CVSubheading
      {Work group on Atiyah-Singer index theorem}{2014}
      {I organised a work group in the ENS following « Seminar on Atiyah-Singer index theorem » by S. Palais}{France}
   \CVSubHeadingListEnd
